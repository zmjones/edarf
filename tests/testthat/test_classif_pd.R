...
test_that("randomForest.formula", {
              ...
              pd_lst <- partial_dependence(fit_rf_f, df, c("X1", "X2"), cutoff)
              expect_that(colnames(pd_lst), equals(c("value", "y", "variable")))
              expect_that(pd_lst$value, is_a("numeric"))
              expect_that(pd_lst$y, is_a("factor"))
              expect_that(pd_lst$variable, is_a("character"))
          })
...
##               pd_lst <- partial_dependence(fit_rf_d, df, c("X1", "X2"), cutoff)
##               expect_that(colnames(pd_lst), equals(c("value", "y", "variable")))
##               expect_that(pd_lst$value, is_a("numeric"))
##               expect_that(pd_lst$y, is_a("factor"))
##               expect_that(pd_lst$variable, is_a("character"))
...
test_that("cforest", {
              ...
              pd_lst <- partial_dependence(fit_cf, df, c("X1", "X2"), cutoff)
              expect_that(colnames(pd_lst), equals(c("value", "y", "variable")))
              expect_that(pd_lst$value, is_a("numeric"))
              expect_that(pd_lst$y, is_a("factor"))
              expect_that(pd_lst$variable, is_a("character"))
...
test_that("rfsrc", {
              ...
              pd_lst <- partial_dependence(fit_rfsrc, df, c("X1", "X2"), cutoff)
              expect_that(colnames(pd_lst), equals(c("value", "y", "variable")))
              expect_that(pd_lst$value, is_a("numeric"))
              expect_that(pd_lst$y, is_a("factor"))
              expect_that(pd_lst$variable, is_a("character"))
